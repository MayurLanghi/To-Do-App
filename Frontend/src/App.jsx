    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4'>
      <div className='bg-white rounded-2xl shadow-xl w-full max-w-lg p-8'>
        ...
        <form onSubmit={addTodo} className='flex items-center gap-2 shadow-sm border border-gray-200 p-2 rounded-lg'>
          ...
          <button 
            type='submit' 
            className='bg-blue-400 hover:bg-blue-600 text-white px-4 py-2 rounded-md font-medium cursor-pointer'>
            Add Task
          </button>
        </form>
              ...
              <div key={todo._id}>
                {editingTodo === todo._id ? (
                  <div className='flex items-center gap-x-3'>
                    <input
                      className='flex-1 p-3 rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-blue-300 text-gray-700 shadow-inner'
                      type='text'
                      value={editedText}
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-x-4 overflow-hidden'>
                      ...
                      <span className={`truncate font-medium ${todo.completed ? "text-gray-400 line-through" : "text-gray-800"}`}>
                        {todo.text}
                      </span>
                    </div>
                    <div className='flex gap-x-2'>
